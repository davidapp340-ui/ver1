...
export default function ParentFaqScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: Math.max(insets.top, 20) + 12 }]}>
        ...
        <Text style={styles.headerTitle}>{t('science.faq.title')}</Text>
      ...
      {loading ? (
        <View style={styles.centerContent}>
          ...
          <Text style={styles.loadingText}>{t('science.faq.loading')}</Text>
        </View>
      ) : error ? (
        <View style={styles.centerContent}>
        ...
        <View style={styles.centerContent}>
          <Text style={styles.emptyText}>{t('science.faq.empty')}</Text>
        </View>
      ) : (
        <ScrollView
